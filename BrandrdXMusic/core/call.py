...
# ============================================================
# 🛡️ SAFE IMPORTS (Fix for ImportError)
# ============================================================
try:
...
try:
    from pytgcalls.exceptions import AlreadyJoined
except ImportError:
...
class Call:
    ...
    async def start(self):
        LOGGER(__name__).info("🚀 Titan Engine v5.1 (Import Fixed) Starting...")
        await asyncio.gather(*[c.start() for c in self.clients])
        await self.decorators()
        LOGGER(__name__).info("✅ Titan Engine Online.")
